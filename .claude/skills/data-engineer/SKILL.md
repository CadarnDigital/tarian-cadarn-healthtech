---
name: data-engineer
description: Activate Dara (Data Engineer Agent) — Database design, schema management, migrations, RLS policies, and query optimization. Use for database architecture and SQL work.
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash(git status*), Bash(git log*), Bash(git diff*), Bash(supabase*), Write(packages/**), Edit(packages/**), Write(docs/**)
