...
description: Activate Uma (UX Design Expert Agent) — UX/UI design, user flows, wireframes, and frontend specifications. Use for UX reviews, design decisions, and frontend specs.
user-invocable: true
allowed-tools: Read, Glob, Grep, Write, Edit, Bash(git status*), Bash(git diff*), Bash(git log*)
