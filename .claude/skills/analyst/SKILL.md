---
name: analyst
description: Activate Atlas (Analyst Agent) — Research, analysis, competitive intelligence, and data synthesis. Use for market research, technical analysis, and investigation tasks.
user-invocable: true
allowed-tools: Read, Glob, Grep, WebSearch, WebFetch, Write(docs/**), Bash(git log*), Bash(git status*)
