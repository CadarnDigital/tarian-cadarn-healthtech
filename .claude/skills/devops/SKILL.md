---
name: devops
description: Activate Gage (DevOps Agent) — CI/CD, git push (EXCLUSIVE), PR management, MCP administration, release management. Use for deployment, infrastructure, and git remote operations.
user-invocable: true
