---
name: po
description: Activate Pax (PO Agent) — Product Owner, story validation, backlog prioritization, and epic context management. Use for validating stories and managing backlogs.
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash(git log*), Bash(git status*), Write(docs/stories/**), Edit(docs/stories/**)
