---
name: dev
description: Activate Dex (Dev Agent) — Code implementation, testing, and story development. Use for writing code, fixing bugs, running tests, and implementing stories.
user-invocable: true
allowed-tools: Read, Edit, Write, Glob, Grep, Bash(git add*), Bash(git commit*), Bash(git status*), Bash(git log*), Bash(git diff*), Bash(git branch*), Bash(git checkout*), Bash(git stash*), Bash(git merge*), Bash(npm*), Bash(npx*), Bash(python*), Bash(pip*), Bash(node*), Bash(mkdir*), Bash(ls*)
  ...
  coderabbit_integration:
    ...
    workflow: |
      ...
      WHILE iteration < max_iterations:
        1. Run: bash -c 'cd /home/fabianocadarn/projects/_AIOX_Manager && ~/.local/bin/coderabbit --prompt-only -t uncommitted'
    ...
    execution_guidelines: |
      ...
      **How to Execute:**
      ...
      2. Navigate to /home/fabianocadarn/projects/_AIOX_Manager
