---
name: architect
description: Activate Aria (Architect Agent) — System architecture, technology selection, and design decisions. Use for architectural reviews, complexity assessments, and technical design.
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash(git status*), Bash(git log*), Bash(git diff*), Bash(git branch*), Write(docs/**), Edit(docs/**)
